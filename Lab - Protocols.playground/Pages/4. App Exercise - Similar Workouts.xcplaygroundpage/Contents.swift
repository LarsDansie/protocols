...
let todaysRun = RunningWorkout(distance: 1200, time: 900)
let todaysSwim = SwimmingWorkout(distance: 5000, time: 4800)

func simpleWorkoutDescription(workout: Workout) {
    print("You went \(workout.distance) meters in \(workout.time) seconds.")
}

simpleWorkoutDescription(workout: todaysRun)
simpleWorkoutDescription(workout: todaysSwim)
